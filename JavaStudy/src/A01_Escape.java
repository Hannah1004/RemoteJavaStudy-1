...
public class A01_Escape {
	/*
	 Escape 문자
	 - 특수한 기능을 가진 문자들
	 - 그냥 출력하려고 하 문제가 발생할 위험이 있는 문자들
	 - 앞에 \가 붙은 문자는 이스케이프 문자로 간주한다
	 - 앞에 붙은 \와 뒤의 문자를 하나의 문자로 인식한
	...
	public static void main(String[] args) {
		...
		// Escape 문자의 기능을 사용하지 않고 \를 출력하고 싶을 
		...
		// \" : "의 기능을 사용하지 않고 그냥 "를 출력하고 싶을 떼  
		// \' : '의 기능을 사용하지 않고 그냥 '을 출력하고 싶을 떼  
