...
//			System.out.println("Set에" + ranNum + "이 더해집니다");
		...
		while(true) {
			...
			if (checkList.size() == 1) {
				...
				if (checkList.get(0) == bonus) {
					...
					System.out.println("1등 당첨입니다 !" + count + "번 도전하셨고," + "여태까지 쓰신 돈은 : " + spent + "원 입니다");
				} else {
					System.out.println("2등 당첨입니다 !" + count + "번 도전하셨고," + "여태까지 쓰신 돈은 : " + spent + "원 입니다");
				}
				break;
			}
			checkList.clear();
	...
	public static void main(String[] args) {
		D02_LottoAnswer quiz = new D02_LottoAnswer();
